...
const SubscriptionAnayliticReportedList = () => {
  ...
  const fetchManageUserDetails = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/subscription_analytical_report?action=get_business_analytical_report`);
  ...
  return (
    <>
      <div className="col-xl-12" style={{ backgroundColor: '#FFF', borderRadius: '12px', padding: '10px', marginBottom: '20px' }}>
        ...
        >
          Subscription Analytical Reports
        </p>
      </div>
      <Typography
        ...
        gutterBottom
      >
        2025 Monthly Analytical Reports of Subscription
      </Typography>
      ...
      <Grid container>
        ...
        <Typography className="" style={{ margin: ' 40px auto 30px', color: '#000' }} variant="h3" gutterBottom>
          2025 Yearly Analytical Reports of Subscription
        </Typography>
...
export default SubscriptionAnayliticReportedList;
