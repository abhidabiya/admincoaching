...
const BusinessAnaReport = () => {
  ...
  const fetchManageUserDetails = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/business_analytical_report?action=get_business_analytical_report`);
  ...
  return (
    <>
      ...
      <Typography
        ...
        gutterBottom
      >
        2025 Monthly Analytical Reports of Business
      </Typography>
      ...
      <Grid container>
        ...
        <Typography className="" style={{ margin: ' 40px auto 30px', color: '#000' }} variant="h3" gutterBottom>
          2025 Yearly Analytical Reports of Business
        </Typography>
...
export default BusinessAnaReport;
